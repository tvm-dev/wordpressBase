...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'WP_BASE_aa46ed9c2446cd009615_20241102174305_archive.zip';
        const ARCHIVE_SIZE       = '56807356';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'aa46ed9-02174305';
        const SECONDARY_PACKAGE_HASH = 'f1b554d-02174305';
